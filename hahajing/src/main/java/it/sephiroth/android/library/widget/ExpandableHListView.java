...
import it.sephiroth.android.library.widget.ExpandableHListConnector.PositionMetadata;
...
public class ExpandableHListView extends HListView {
    ...
    public ExpandableHListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setGroupIndicator(a.getDrawable(3));
        setChildIndicator(a.getDrawable(4));
        this.mIndicatorLeft = a.getDimensionPixelSize(5, 0);
        this.mIndicatorTop = a.getDimensionPixelSize(6, 0);
        this.mIndicatorGravity = a.getInt(0, 0);
        this.mChildIndicatorGravity = a.getInt(1, 0);
        this.mChildIndicatorLeft = a.getDimensionPixelSize(7, 0);
        this.mChildIndicatorTop = a.getDimensionPixelSize(8, 0);
        this.mChildDivider = a.getDrawable(2);
        a.recycle();
    }
