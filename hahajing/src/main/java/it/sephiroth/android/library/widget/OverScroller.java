...
public class OverScroller {
        ...
        boolean update() {
            ...
            switch (this.mState) {
                ...
                case 1:
                    ...
                    this.mCurrVelocity = ((((float) this.mOver) * sign) * GLFlingMesh.minIndexSize) * ((-t) + t2);
                    break;
                case 2:
    ...
    static {
        sViscousFluidNormalize = TextTrackStyle.DEFAULT_FONT_SCALE;
        sViscousFluidNormalize = TextTrackStyle.DEFAULT_FONT_SCALE / viscousFluid(TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    public static float viscousFluid(float x) {
        ...
        if (x < TextTrackStyle.DEFAULT_FONT_SCALE) {
            x -= TextTrackStyle.DEFAULT_FONT_SCALE - ((float) Math.exp((double) (-x)));
        } else {
            x = 0.36787945f + ((TextTrackStyle.DEFAULT_FONT_SCALE - 0.36787945f) * (TextTrackStyle.DEFAULT_FONT_SCALE - ((float) Math.exp((double) (TextTrackStyle.DEFAULT_FONT_SCALE - x)))));
        }
