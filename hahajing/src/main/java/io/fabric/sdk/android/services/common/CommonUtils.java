...
*/
    ...
    public static boolean getBooleanResourceValue(Context context, String key, boolean defaultValue) {
        ...
        id = getResourcesIdentifier(context, key, IXMLRPCSerializer.TYPE_STRING);
        if (id > 0) {
    ...
    public static Cipher createCipher(int mode, String key) throws InvalidKeyException {
        ...
        SecretKey secretKey = new SecretKeySpec(key.getBytes(), 0, 32, ENCRYPTION_AES);
        try {
    ...
    public static String getStringsFileValue(Context context, String key) {
        int id = getResourcesIdentifier(context, key, IXMLRPCSerializer.TYPE_STRING);
        if (id > 0) {
    ...
    public static String resolveBuildId(Context context) {
        int id = getResourcesIdentifier(context, CRASHLYTICS_BUILD_ID, IXMLRPCSerializer.TYPE_STRING);
        if (id == 0) {
            return null;
        }
