...
public abstract class EventsFilesManager<T> {
    ...
    public EventsFilesManager(Context context, EventTransform<T> transform, CurrentTimeProvider currentTimeProvider, EventsStorage eventStorage, int maxFilesToKeep) throws IOException {
    ...
    EventsFilesManager(Context context, EventTransform<T> transform, CurrentTimeProvider currentTimeProvider, EventsStorage eventStorage) throws IOException {
    ...
    public void deleteOldestInRollOverIfOverMax() {
        ...
        if (allFiles.size() > this.maxFilesToKeep) {
            int numberOfFilesToDelete = allFiles.size() - this.maxFilesToKeep;
            CommonUtils.logControlled(this.context, String.format(Locale.US, "Found %d files in  roll over directory, this is greater than %d, deleting %d oldest files", new Object[]{Integer.valueOf(allFiles.size()), Integer.valueOf(this.maxFilesToKeep), Integer.valueOf(numberOfFilesToDelete)}));
