        ...
        try {
            ...
            if (this.context.bindService(intent, connection, 1)) {
                try {
                    ...
                    advertisingInfo = this.context;
                    advertisingInfo.unbindService(connection);
                }
            ...
            Fabric.getLogger().d("Fabric", "Google Play Services unavailable to capture AdvertisingId");
            return null;
        }
    }
}
