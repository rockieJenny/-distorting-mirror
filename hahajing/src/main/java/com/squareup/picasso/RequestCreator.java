...
public class RequestCreator {
    ...
    public Bitmap get() throws IOException {
        ...
        if (this.deferred) {
            ...
            return BitmapHunter.forRequest(this.picasso, this.picasso.dispatcher, this.picasso.cache, this.picasso.stats, new GetAction(this.picasso, finalData, this.skipMemoryCache, Utils.createKey(finalData, new StringBuilder()), this.tag)).hunt();
        }
    }
    ...
    public void fetch() {
        ...
        if (this.deferred) {
            ...
            this.picasso.submit(new FetchAction(this.picasso, request, this.skipMemoryCache, Utils.createKey(request, new StringBuilder()), this.tag));
        }
    }
    ...
    public void into(Target target) {
        ...
        if (target == null) {
            ...
            this.picasso.enqueueAndSubmit(new TargetAction(this.picasso, target, request, this.skipMemoryCache, this.errorResId, this.errorDrawable, requestKey, this.tag));
        } else {
            this.picasso.cancelRequest(target);
            if (this.setPlaceholder) {
                drawable = getPlaceholderDrawable();
    ...
    public void into(RemoteViews remoteViews, int viewId, int notificationId, Notification notification) {
        ...
        if (remoteViews == null) {
            ...
            performRemoteViewInto(new NotificationAction(this.picasso, request, remoteViews2, i, i2, notification2, this.skipMemoryCache, this.errorResId, Utils.createKey(request), this.tag));
        } else {
    ...
    public void into(RemoteViews remoteViews, int viewId, int[] appWidgetIds) {
        ...
        if (remoteViews == null) {
            ...
            performRemoteViewInto(new AppWidgetAction(this.picasso, request, remoteViews2, i, iArr, this.skipMemoryCache, this.errorResId, Utils.createKey(request), this.tag));
        } else {
            throw new IllegalArgumentException("Cannot use placeholder or error drawables with remote views.");
        }
    }
    ...
    public void into(ImageView target, Callback callback) {
        ...
        if (target == null) {
            ...
            this.picasso.enqueueAndSubmit(new ImageViewAction(this.picasso, target, request, this.skipMemoryCache, this.noFade, this.errorResId, this.errorDrawable, requestKey, this.tag, callback));
        } else {
            this.picasso.cancelRequest(target);
            if (this.setPlaceholder) {
                PicassoDrawable.setPlaceholder(target, getPlaceholderDrawable());
