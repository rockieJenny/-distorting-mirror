...
class BitmapHunter implements Runnable {
    ...
    public void run() {
        /*
        r5 = this;
        r2 = r5.data;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        updateThreadName(r2);	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r2 = r5.picasso;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r2 = r2.loggingEnabled;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        if (r2 == 0) goto L_0x0016;
    L_0x000b:
        r2 = "Hunter";
        r3 = "executing";
        r4 = com.squareup.picasso.Utils.getLogIdsForHunter(r5);	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        com.squareup.picasso.Utils.log(r2, r3, r4);	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
    L_0x0016:
        r2 = r5.hunt();	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r5.result = r2;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r2 = r5.result;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        if (r2 != 0) goto L_0x002f;
    L_0x0020:
        r2 = r5.dispatcher;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r2.dispatchFailed(r5);	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
    L_0x0025:
    ...
    L_0x002f:
        r2 = r5.dispatcher;	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        r2.dispatchComplete(r5);	 Catch:{ ResponseException -> 0x0035, IOException -> 0x0047, OutOfMemoryError -> 0x0059, Exception -> 0x0087 }
        goto L_0x0025;
    L_0x0035:
        r0 = move-exception;
        r5.exception = r0;	 Catch:{ all -> 0x0099 }
        r2 = r5.dispatcher;	 Catch:{ all -> 0x0099 }
        r2.dispatchFailed(r5);	 Catch:{ all -> 0x0099 }
        r2 = java.lang.Thread.currentThread();
        r3 = "Picasso-Idle";
        r2.setName(r3);
        goto L_0x002e;
    L_0x0047:
        ...
        r5.exception = r0;	 Catch:{ all -> 0x0099 }
        r2 = r5.dispatcher;	 Catch:{ all -> 0x0099 }
        r2.dispatchRetry(r5);	 Catch:{ all -> 0x0099 }
        r2 = java.lang.Thread.currentThread();
        r3 = "Picasso-Idle";
        r2.setName(r3);
        goto L_0x002e;
    L_0x0059:
        ...
        r5.exception = r2;	 Catch:{ all -> 0x0099 }
        r2 = r5.dispatcher;	 Catch:{ all -> 0x0099 }
        r2.dispatchFailed(r5);	 Catch:{ all -> 0x0099 }
        r2 = java.lang.Thread.currentThread();
        r3 = "Picasso-Idle";
    ...
    Bitmap hunt() throws IOException {
        ...
        Result result = this.requestHandler.load(this.data);
        if (result != null) {
