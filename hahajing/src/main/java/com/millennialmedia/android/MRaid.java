    ...
    static String getMMJSStats(Context context) {
        ...
        try {
            ...
            try {
                ...
                md5Hash = MMSDK.byteArrayToString(MessageDigest.getInstance(CommonUtils.MD5_INSTANCE).digest(contents));
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(line)) {
                            if (line.contains("* Built") && TextUtils.isEmpty(buildDate)) {
                                buildDate = line;
                                MMLog.d(TAG, "MMJS BuildDate:" + buildDate);
                            }
                            if (line.contains("* Version") && TextUtils.isEmpty(version)) {
                                version = line;
                                MMLog.d(TAG, "MMJS Version:" + version);
                            }
                ...
                if (fileStream2 != null) {
                    try {
                        ...
                        MMLog.e(TAG, "Exception closing file: ", e3);
                    }
                }
                if (reader2 != null) {
                    reader2.close();
                ...
                fileStream = fileStream2;
                try {
                    MMLog.e(TAG, "MMJS stats exception: ", e3);
                    if (fileStream != null) {
                        try {
                            fileStream.close();
                        } catch (Exception e32) {
                            MMLog.e(TAG, "Exception closing file: ", e32);
                        }
                    }
                    if (reader != null) {
                        reader.close();
                    ...
                    if (fileStream != null) {
                        try {
                            ...
                            MMLog.e(TAG, "Exception closing file: ", e322);
                            throw th;
                        }
                    }
                    if (reader != null) {
            ...
            e322 = e5;
            MMLog.e(TAG, "MMJS stats exception: ", e322);
            if (fileStream != null) {
                fileStream.close();
            }
            if (reader != null) {
