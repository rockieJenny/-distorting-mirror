...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            jx.a(plusClient != null, "PlusClient must not be null.");
            jx.a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            jx.a(plusClient.os().cj(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            jx.b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                jx.a(PlusShare.cg(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            jx.a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            jx.a(z3, "The content URL is required for interactive posts.");
            ...
            jx.a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                jx.a(PlusShare.cg(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            jx.b(this.anE, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            jx.b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
    ...
    protected static boolean cg(String str) {
    ...
    public static Person createPerson(String id, String displayName) {
        if (TextUtils.isEmpty(id)) {
            ...
            return new pi(displayName, id, null, 0, null);
        } else {
