...
@ey
public class di {
    static final Set<String> rk = new HashSet(Arrays.asList(new String[]{"top-left", "top-right", "top-center", AdCreative.kAlignmentCenter, "bottom-left", "bottom-right", "bottom-center"}));
    private int li = -1;
    private int lj = -1;
