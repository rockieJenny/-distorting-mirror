...
public final class pd extends ks implements ItemScope {
    ...
    static {
        ...
        aom.put(MMRequest.KEY_GENDER, a.l(MMRequest.KEY_GENDER, 28));
        aom.put(Event.INTENT_MAPS, a.a(Event.INTENT_MAPS, 29, pd.class));
        aom.put("givenName", a.l("givenName", 30));
        aom.put("height", a.l("height", 31));
        aom.put(AnalyticsEvent.EVENT_ID, a.l(AnalyticsEvent.EVENT_ID, 32));
        ...
        aom.put(IXMLRPCSerializer.TAG_NAME, a.l(IXMLRPCSerializer.TAG_NAME, 39));
        ...
        aom.put(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, a.l(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, 53));
        aom.put("url", a.l("url", 54));
    ...
    protected Object b(a aVar) {
        switch (aVar.hR()) {
            ...
            case ApiEventType.API_MRAID_HIDE_VIDEO /*48*/:
                return this.apb;
            case ApiEventType.API_MRAID_SHOW_VIDEO /*49*/:
                return this.apc;
            case 50:
                return this.apd;
            case ApiEventType.API_MRAID_GET_MIC_INTENSITY /*51*/:
                return this.ape;
            case 52:
                return this.apf;
            case 53:
