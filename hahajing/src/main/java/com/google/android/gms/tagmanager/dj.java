...
class dj extends dg {
    ...
    private Promotion L(Map<String, String> map) {
        ...
        String str = (String) map.get(AnalyticsEvent.EVENT_ID);
        if (str != null) {
            promotion.setId(String.valueOf(str));
        }
        str = (String) map.get(IXMLRPCSerializer.TAG_NAME);
        if (str != null) {
    ...
    private Product M(Map<String, Object> map) {
        ...
        Object obj = map.get(AnalyticsEvent.EVENT_ID);
        if (obj != null) {
            product.setId(String.valueOf(obj));
        }
        obj = map.get(IXMLRPCSerializer.TAG_NAME);
        if (obj != null) {
    ...
    private Map<String, String> N(Map<String, d.a> map) {
        ...
        if (aux == null) {
            ...
            hashMap.put(AnalyticsSQLiteHelper.TRANSACTION_ID, Fields.TRANSACTION_ID);
    ...
    private Map<String, String> O(Map<String, d.a> map) {
        ...
        if (auy == null) {
            Map hashMap = new HashMap();
            hashMap.put(IXMLRPCSerializer.TAG_NAME, Fields.ITEM_NAME);
    ...
    private void a(Tracker tracker, Map<String, d.a> map) {
        String de = de(AnalyticsSQLiteHelper.TRANSACTION_ID);
        if (de == null) {
        ...
        try {
            ...
            if (df != null) {
                for (Map map2 : df) {
                    if (map2.get(IXMLRPCSerializer.TAG_NAME) == null) {
                    ...
                    p2.put(Fields.TRANSACTION_ID, de);
    ...
    private void b(Tracker tracker, Map<String, d.a> map) {
        ...
        if (map2 != null) {
            Map map3;
            List<Map> list;
            String str = (String) p.get(Fields.CURRENCY_CODE);
            if (str == null) {
                str = (String) map2.get(AnalyticsSQLiteHelper.TRANSACTION_ITEM_CURRENCY_CODE);
            }
            if (str != null) {
                screenViewBuilder.set(Fields.CURRENCY_CODE, str);
            }
