...
public final class cj implements cd {
    ...
    public void a(gu guVar, Map<String, String> map) {
        ...
        boolean equalsIgnoreCase = AppSettingsData.STATUS_NEW.equalsIgnoreCase(str);
        ...
        if (ce == null) {
            ...
            str = (String) map.get(MirrorPixelShader.UNIFORM_ENABLED);
            if (str == null) {
            ...
            ce.C((String) map.get(AdTrackerConstants.SOURCE));
        } else {
