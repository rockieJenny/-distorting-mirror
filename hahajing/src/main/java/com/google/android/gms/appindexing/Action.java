...
public final class Action extends Thing {
    ...
    public static final class Builder extends com.google.android.gms.appindexing.Thing.Builder {
        public Builder(String actionType) {
            jx.i(actionType);
            super.put(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, actionType);
        }

        public Action build() {
            jx.b(this.DJ.get("object"), (Object) "setObject is required before calling build().");
            jx.b(this.DJ.get(AnalyticsSQLiteHelper.EVENT_LIST_TYPE), (Object) "setType is required before calling build().");
            Bundle bundle = (Bundle) this.DJ.getParcelable("object");
            jx.b(bundle.get(IXMLRPCSerializer.TAG_NAME), (Object) "Must call setObject() with a valid name. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
            jx.b(bundle.get("url"), (Object) "Must call setObject() with a valid app url. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
        ...
        public Builder setName(String name) {
            return (Builder) super.put(IXMLRPCSerializer.TAG_NAME, name);
        }
