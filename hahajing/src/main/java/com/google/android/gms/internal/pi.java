...
public final class pi extends ks implements Person {
    ...
    public static final class b extends ks implements Cover {
        ...
        public static final class b extends ks implements CoverPhoto {
            ...
            static {
                ...
                aom.put("url", com.google.android.gms.internal.kr.a.l("url", 3));
        ...
        static {
            ...
            aom.put("layout", com.google.android.gms.internal.kr.a.a("layout", 4, new ko().h(AdCreative.kFormatBanner, 0), false));
        }
    ...
    public static final class c extends ks implements Image {
        ...
        static {
            aom.put("url", com.google.android.gms.internal.kr.a.l("url", 2));
        }
    ...
    public static final class f extends ks implements Organizations {
        ...
        static {
            ...
            aom.put(IXMLRPCSerializer.TAG_NAME, com.google.android.gms.internal.kr.a.l(IXMLRPCSerializer.TAG_NAME, 6));
            ...
            aom.put("title", com.google.android.gms.internal.kr.a.l("title", 9));
            aom.put(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, com.google.android.gms.internal.kr.a.a(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, 10, new ko().h("work", 0).h("school", 1), false));
        }
    ...
    public static final class h extends ks implements Urls {
        ...
        static {
            ...
            aom.put(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, com.google.android.gms.internal.kr.a.a(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, 6, new ko().h("home", 0).h("work", 1).h("blog", 2).h(Scopes.PROFILE, 3).h("other", 4).h("otherProfile", 5).h("contributor", 6).h("website", 7), false));
    ...
    static {
        ...
        aom.put(MMRequest.KEY_GENDER, com.google.android.gms.internal.kr.a.a(MMRequest.KEY_GENDER, 12, new ko().h(MMRequest.GENDER_MALE, 0).h(MMRequest.GENDER_FEMALE, 1).h("other", 2), false));
        aom.put(AnalyticsEvent.EVENT_ID, com.google.android.gms.internal.kr.a.l(AnalyticsEvent.EVENT_ID, 14));
        ...
        aom.put(IXMLRPCSerializer.TAG_NAME, com.google.android.gms.internal.kr.a.a(IXMLRPCSerializer.TAG_NAME, 19, d.class));
        ...
        aom.put("relationshipStatus", com.google.android.gms.internal.kr.a.a("relationshipStatus", 25, new ko().h(MMRequest.MARITAL_SINGLE, 0).h("in_a_relationship", 1).h(MMRequest.MARITAL_ENGAGED, 2).h(MMRequest.MARITAL_MARRIED, 3).h("its_complicated", 4).h("open_relationship", 5).h("widowed", 6).h("in_domestic_partnership", 7).h("in_civil_union", 8), false));
        aom.put("tagline", com.google.android.gms.internal.kr.a.l("tagline", 26));
        aom.put("url", com.google.android.gms.internal.kr.a.l("url", 27));
