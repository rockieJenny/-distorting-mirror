...
public final class qx {
    private static void a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        if (obj != null) {
            if (obj instanceof qw) {
                ...
                if (str != null) {
                    stringBuffer2.append(stringBuffer).append(dl(str)).append(" <\n");
                    stringBuffer.append("  ");
                }
                ...
                for (Field field : cls.getFields()) {
                    ...
                    if (!((modifiers & 1) != 1 || (modifiers & 8) == 8 || name.startsWith(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR) || name.endsWith(EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR))) {
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(dm((String) obj)).append("\"");
    ...
    public static <T extends qw> String g(T t) {
        if (t == null) {
            return "";
        }
        StringBuffer stringBuffer = new StringBuffer();
