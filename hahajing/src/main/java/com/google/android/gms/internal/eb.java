...
public class eb {
    ...
    public Bundle a(String str, String str2, String str3) {
        try {
            ...
            return (Bundle) loadClass.getDeclaredMethod("getBuyIntent", new Class[]{Integer.TYPE, String.class, String.class, String.class, String.class}).invoke(loadClass.cast(this.sC), new Object[]{Integer.valueOf(3), str, str2, AnalyticsEvent.IN_APP, str3});
        } catch (Throwable e) {
    ...
    public Bundle d(String str, String str2) {
        try {
            Class loadClass = this.mContext.getClassLoader().loadClass("com.android.vending.billing.IInAppBillingService");
            return (Bundle) loadClass.getDeclaredMethod("getPurchases", new Class[]{Integer.TYPE, String.class, String.class, String.class}).invoke(loadClass.cast(this.sC), new Object[]{Integer.valueOf(3), str, AnalyticsEvent.IN_APP, str2});
        } catch (Throwable e) {
            gr.d("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", e);
            return null;
        }
