    ...
    public static abstract class Stub extends Binder implements IGamesCallbacks {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5002:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    c(data.readInt() != 0 ? DataHolder.CREATOR.B(data) : null);
                    reply.writeNoException();
                    return true;
                case 5003:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 8007:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    h(data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
                case 8008:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 12004:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    a(data.readInt() != 0 ? DataHolder.CREATOR.B(data) : null, data.readInt() != 0 ? (Contents) Contents.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 12005:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 12012:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    i(data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
                case 12013:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 12017:
                    Contents contents;
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    DataHolder B2 = data.readInt() != 0 ? DataHolder.CREATOR.B(data) : null;
                    ...
                    a(B2, readString, contents2, contents3, contents);
                    reply.writeNoException();
                    return true;
                case 13001:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                ...
                case 14001:
                    data.enforceInterface("com.google.android.gms.games.internal.IGamesCallbacks");
                    a((DataHolder[]) data.createTypedArray(DataHolder.CREATOR));
                    reply.writeNoException();
                    return true;
                case 1598968902:
