...
public final class GoogleAuthUtil {
    ...
    private static final ComponentName Ek = new ComponentName("com.google.android.gms", "com.google.android.gms.auth.GetToken");
    private static final ComponentName El = new ComponentName("com.google.android.gms", "com.google.android.gms.recovery.RecoveryService");
    private static final Intent Em = new Intent().setPackage("com.google.android.gms").setComponent(Ek);
    private static final Intent En = new Intent().setPackage("com.google.android.gms").setComponent(El);
