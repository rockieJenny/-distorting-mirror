...
public class gx extends gv {
    ...
    protected WebResourceResponse d(Context context, String str, String str2) throws IOException {
        ...
        try {
            ...
            webResourceResponse = new WebResourceResponse("application/javascript", HttpRequest.CHARSET_UTF8, new ByteArrayInputStream(gi.a(new InputStreamReader(httpURLConnection.getInputStream())).getBytes(HttpRequest.CHARSET_UTF8)));
