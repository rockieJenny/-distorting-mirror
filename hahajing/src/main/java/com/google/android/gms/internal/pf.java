...
public final class pf extends ks implements Moment {
    ...
    static {
        aom.put(AnalyticsEvent.EVENT_ID, a.l(AnalyticsEvent.EVENT_ID, 2));
        aom.put("result", a.a("result", 4, pd.class));
        aom.put("startDate", a.l("startDate", 5));
        aom.put("target", a.a("target", 6, pd.class));
        aom.put(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, a.l(AnalyticsSQLiteHelper.EVENT_LIST_TYPE, 7));
    }
