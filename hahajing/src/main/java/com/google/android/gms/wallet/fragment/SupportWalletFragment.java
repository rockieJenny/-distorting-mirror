...
public final class SupportWalletFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(MirrorPixelShader.UNIFORM_ENABLED)) {
                this.awi = Boolean.valueOf(savedInstanceState.getBoolean(MirrorPixelShader.UNIFORM_ENABLED));
            }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (this.awi != null) {
            outState.putBoolean(MirrorPixelShader.UNIFORM_ENABLED, this.awi.booleanValue());
            this.awi = null;
        }
    }
