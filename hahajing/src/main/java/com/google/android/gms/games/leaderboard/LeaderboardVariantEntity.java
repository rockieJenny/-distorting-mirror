...
public final class LeaderboardVariantEntity implements LeaderboardVariant {
    ...
    static String b(LeaderboardVariant leaderboardVariant) {
        return jv.h(leaderboardVariant).a("TimeSpan", TimeSpan.dZ(leaderboardVariant.getTimeSpan())).a("Collection", LeaderboardCollection.dZ(leaderboardVariant.getCollection())).a("RawPlayerScore", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getRawPlayerScore()) : AdCreative.kFixNone).a("DisplayPlayerScore", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerScore() : AdCreative.kFixNone).a("PlayerRank", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getPlayerRank()) : AdCreative.kFixNone).a("DisplayPlayerRank", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerRank() : AdCreative.kFixNone).a("NumScores", Long.valueOf(leaderboardVariant.getNumScores())).a("TopPageNextToken", leaderboardVariant.mK()).a("WindowPageNextToken", leaderboardVariant.mM()).a("WindowPagePrevToken", leaderboardVariant.mL()).toString();
    }
