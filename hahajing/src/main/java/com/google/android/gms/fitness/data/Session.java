...
public class Session implements SafeParcelable {
    ...
    public String toString() {
        return jv.h(this).a("startTime", Long.valueOf(this.LW)).a("endTime", Long.valueOf(this.TO)).a(IXMLRPCSerializer.TAG_NAME, this.mName).a(SettingsJsonConstants.APP_IDENTIFIER_KEY, this.UN).a(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, this.UO).a("activity", Integer.valueOf(this.TZ)).a("application", this.Um).toString();
    }
