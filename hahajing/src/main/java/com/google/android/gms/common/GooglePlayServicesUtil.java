...
public final class GooglePlayServicesUtil {
    ...
    public static boolean b(PackageManager packageManager) {
        synchronized (Jj) {
            if (Ji == -1) {
                try {
                    if (a(packageManager.getPackageInfo("com.google.android.gms", 64), b.Jc[1]) != null) {
                        Ji = 1;
                    } else {
                        Ji = 0;
                    }
    ...
    private static boolean b(Resources resources) {
        ...
        return ll.ii() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT;
    }
