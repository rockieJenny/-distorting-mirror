...
import com.google.android.gms.internal.pi.e;
...
public final class pt extends d implements Person {
    ...
    public int getObjectType() {
        return e.ck(getString("objectType"));
    }
    ...
    public ArrayList<Organizations> oW() {
        return null;
    }

    public ArrayList<PlacesLived> oX() {
        return null;
    }

    public ArrayList<Urls> oY() {
        return null;
    }

    public Person oZ() {
        return new pi(getDisplayName(), getId(), (c) getImage(), getObjectType(), getUrl());
    }
}
