...
class ResourceStorageImpl implements ResourceStorage {
    ...
    L_0x000c:
        ...
        com.google.tagmanager.Log.v(r2);
    ...
    L_0x0066:
        ...
        com.google.tagmanager.Log.d(r2);
        r2 = r4.mCallback;
        r3 = com.google.tagmanager.LoadCallback.Failure.NOT_AVAILABLE;
        r2.onFailure(r3);
        goto L_0x0045;
    L_0x0074:
        ...
        com.google.tagmanager.Log.w(r2);
        goto L_0x0060;
    L_0x007b:
        r0 = move-exception;
        r2 = "error reading resource from disk";
        com.google.tagmanager.Log.w(r2);	 Catch:{ all -> 0x0093 }
    ...
    public com.google.analytics.containertag.proto.Serving.Resource loadResourceFromContainerAsset(java.lang.String r8) {
        ...
        r5 = r5.append(r8);
        r5 = r5.toString();
        com.google.tagmanager.Log.v(r5);
        r5 = r7.mContext;
        r0 = r5.getAssets();
    ...
    L_0x0026:
        ...
        com.google.tagmanager.Log.v(r5);	 Catch:{ IOException -> 0x006e }
    ...
    L_0x006e:
        ...
        com.google.tagmanager.Log.w(r5);	 Catch:{ all -> 0x008a }
    ...
    L_0x0022:
        ...
        com.google.tagmanager.Log.w(r5);	 Catch:{ all -> 0x0037 }
