...
public class ex {
    ...
    public ex(String str, String str2, boolean z, boolean z2, long j, long j2, List<ez> list, Map<fl, byte[]> map, Map<String, List<String>> map2, Map<String, List<String>> map3, Map<String, Map<String, String>> map4, long j3) throws IOException {
        byte[] bArr;
        Throwable th;
        Closeable closeable = null;
        Closeable dataOutputStream;
        try {
            MessageDigest fvVar = new fv();
            OutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            OutputStream digestOutputStream = new DigestOutputStream(byteArrayOutputStream, fvVar);
            ...
            try {
                ...
                for (Entry entry : map.entrySet()) {
                    dataOutputStream.writeShort(((fl) entry.getKey()).d);
                ...
                gd.a(3, a, "optionsMapSize is:  " + size);
                dataOutputStream.writeShort(size);
                if (map3 != null) {
                    gd.a(3, a, "sending launch options");
                    for (Entry entry22 : map3.entrySet()) {
                        gd.a(3, a, "Launch Options Key:  " + ((String) entry22.getKey()));
                        ...
                        for (String str32 : (List) entry22.getValue()) {
                            ...
                            gd.a(3, a, "Launch Options value is :" + str32);
                        }
                    }
                }
                int size2 = map4 != null ? map4.keySet().size() : 0;
                gd.a(3, a, "numOriginAttributions is:  " + size);
                dataOutputStream.writeShort(size2);
                if (map4 != null) {
                    for (Entry entry222 : map4.entrySet()) {
                        gd.a(3, a, "Origin Atttribute Key:  " + ((String) entry222.getKey()));
                        dataOutputStream.writeUTF((String) entry222.getKey());
                        dataOutputStream.writeShort(((Map) entry222.getValue()).size());
                        gd.a(3, a, "Origin Attribute Map Size for " + ((String) entry222.getKey()) + ":  " + ((Map) entry222.getValue()).size());
                        for (Entry entry3 : ((Map) entry222.getValue()).entrySet()) {
                            String str4;
                            gd.a(3, a, "Origin Atttribute for " + ((String) entry222.getKey()) + ":  " + ((String) entry3.getKey()) + ":" + ((String) entry3.getValue()));
                ...
                dataOutputStream.write(fvVar.a());
