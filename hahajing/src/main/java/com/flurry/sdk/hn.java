...
public class hn {
    public static boolean a() {
        return ((KeyguardManager) fp.a().c().getSystemService("keyguard")).inKeyguardRestrictedInputMode();
    }

    @SuppressLint({"NewApi"})
    public static Point b() {
        Display defaultDisplay = ((WindowManager) fp.a().c().getSystemService("window")).getDefaultDisplay();
