...
public class InMobiAnalytics {
    public static void startSessionManually(Map<String, String> map) {
    ...
    public static void endSessionManually(Map<String, String> map) {
        if (InternalSDKUtil.isInitializedSuccessfully()) {
    ...
    public static void endSection(String str, Map<String, String> map) {
        if (InternalSDKUtil.isInitializedSuccessfully()) {
            try {
    ...
    public static void setUserAttribute(String str, String str2) {
        try {
            if (InternalSDKUtil.isInitializedSuccessfully()) {
                AnalyticsEventsWrapper.getInstance().setUserAttribute(str, str2);
                AnalyticsEventsWrapper.setIsEventsUser();
            }
        } catch (Throwable e) {
            Log.internal(AnalyticsUtils.ANALYTICS_LOGGING_TAG, "Unable to set user attribute unexpected exception.", e);
        }
    }
}
