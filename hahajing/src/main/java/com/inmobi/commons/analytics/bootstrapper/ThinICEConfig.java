...
public class ThinICEConfig {
    ...
    public final void setFromMap(Map<String, Object> map) {
        ...
        this.f = InternalSDKUtil.getIntFromMap(map, "wfd", 0, 15);
        this.g = InternalSDKUtil.getIntFromMap(map, "cof", 0, 15);
        ...
        this.p = InternalSDKUtil.getLongFromMap(map, "assi", 1, Long.MAX_VALUE);
        this.q = InternalSDKUtil.getLongFromMap(map, "asm", 1, Long.MAX_VALUE);
    }
}
