...
public final class AnalyticsNetworkManager {
    ...
    class a extends Thread {
        ...
        a(AnalyticsNetworkManager analyticsNetworkManager) {
            this.a = analyticsNetworkManager;
        }

        public void run() {
            Looper.prepare();
            AnalyticsNetworkManager.a = new Handler(new Callback(this) {
                final /* synthetic */ a a;
    ...
    private void a(AnalyticsPayload analyticsPayload, String str) {
        try {
            ...
            completePayload = a(completePayload, str, z);
            ...
            try {
                bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), HttpRequest.CHARSET_UTF8));
            } catch (Exception e2) {
                try {
                    bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getErrorStream(), HttpRequest.CHARSET_UTF8));
                } catch (Exception e3) {
                    bufferedReader = null;
                }
            }
    ...
    private String a(String str, String str2, boolean z) {
        ...
        stringBuilder.append(encodeMapAndconvertToDelimitedString);
        encodeMapAndconvertToDelimitedString = "pr-SAND-" + InternalSDKUtil.getInMobiInternalVersion(InternalSDKUtil.INMOBI_SDK_RELEASE_VERSION) + "-" + InternalSDKUtil.INMOBI_SDK_RELEASE_DATE;
