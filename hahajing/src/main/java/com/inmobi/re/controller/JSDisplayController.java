...
public class JSDisplayController extends JSController {
    ...
    private float b;
    private OrientationProperties c = null;
    private ResizeProperties d = null;
    ...
    public void setExpandProperties(String str) {
        ...
        try {
            this.expProps = (ExpandProperties) JSController.getFromJSON(new JSONObject(str), ExpandProperties.class);
    ...
    public void setResizeProperties(String str) {
        ...
        try {
            this.d = (ResizeProperties) JSController.getFromJSON(new JSONObject(str), ResizeProperties.class);
    ...
    public void setOrientationProperties(String str) {
        ...
        try {
            this.c = (OrientationProperties) JSController.getFromJSON(new JSONObject(str), OrientationProperties.class);
    ...
    public String getOrientation() {
        ...
        try {
            currentRotation = this.imWebView.getCurrentRotation(this.imWebView.getIntegerCurrentRotation());
            Log.debug(Constants.RENDERING_LOG_TAG, "JSDisplayController-> getOrientation: " + currentRotation);
            return currentRotation;
        } catch (Throwable e) {
            Throwable th = e;
            currentRotation = "-1";
            Log.debug(Constants.RENDERING_LOG_TAG, "Error getOrientation: " + currentRotation, th);
            return currentRotation;
        }
    }
