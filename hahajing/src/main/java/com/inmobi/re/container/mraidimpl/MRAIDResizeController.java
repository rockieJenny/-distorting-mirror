...
public class MRAIDResizeController {
        ...
        try {
            ...
            if (((FrameLayout) this.a.getParent().getParent()).getId() == 435) {
                ...
                this.a.postInHandler(new Runnable(this) {
                    final /* synthetic */ MRAIDResizeController a;
                    ...
                    public void run() {
                        if (this.a.a.mListener != null) {
                            this.a.a.mListener.onResize(this.a.b);
                        }
                    }
                });
    ...
    private void a(ViewGroup viewGroup, String str) {
        ...
        customView.setOnClickListener(new OnClickListener(this) {
            final /* synthetic */ MRAIDResizeController a;
    ...
    private RelativeLayout.LayoutParams a(String str) {
        ...
        if (b.equals("bottom-center") || b.equals("top-center") || b.equals(AdCreative.kAlignmentCenter)) {
    ...
    private String b(String str) {
        if (str.equals("top-left") || str.equals("top-right") || str.equals("bottom-left") || str.equals("bottom-right") || str.equals("top-center") || str.equals("bottom-center") || str.equals(AdCreative.kAlignmentCenter)) {
            return str;
        }
        return "top-right";
    }
