...
public class MRAIDExpandController {
    ...
    public void doExpand(Bundle bundle) {
        ...
        try {
            ...
            this.a.invalidate();
            this.a.postInHandler(new Runnable(this) {
                final /* synthetic */ MRAIDExpandController a;
                ...
                public void run() {
                    if (this.a.a.mListener != null) {
                        this.a.a.mListener.onExpand();
                    }
                }
            });
        } catch (Throwable e22) {
            Log.debug(Constants.RENDERING_LOG_TAG, "Exception in doexpand ", e22);
    ...
    private FrameLayout a(ExpandProperties expandProperties) {
        ...
        frameLayout2.setOnTouchListener(new OnTouchListener(this) {
            final /* synthetic */ MRAIDExpandController a;
    ...
    private void a(ViewGroup viewGroup, boolean z) {
        ...
        int i = (z || this.a.getCustomClose()) ? 8 : 0;
    ...
    public void handleOrientationFor2Piece() {
        try {
            ...
            } else if (this.a.mInterstitialController.orientationValueForInterstitial.equals("portrait")) {
                this.b.setRequestedOrientation(WrapperFunctions.getParamPortraitOrientation(integerCurrentRotation));
            } else if (this.a.mInterstitialController.orientationValueForInterstitial.equals("landscape")) {
